# Generated by Django 3.2.3 on 2025-01-07 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ManyToManyField(related_name='cart', to='recipe.Recipe', verbose_name='Корзина')),
                ('favorites', models.ManyToManyField(related_name='favorites', to='recipe.Recipe', verbose_name='Избранные рецепты')),
                ('followings', models.ManyToManyField(related_name='followers', to=settings.AUTH_USER_MODEL, verbose_name='Подписки')),
