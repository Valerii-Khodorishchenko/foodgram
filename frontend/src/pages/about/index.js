    ...
    <Container>
      ...
      <div className={styles.content}>
        <div>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Представляю вам проект, созданный во время обучения в Яндекс Практикуме. Этот проект — часть учебного курса, но backend-часть и развёртывание проекта созданы полностью самостоятельно.
            </p>
            <p className={styles.textItem}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/Valerii-Khodorishchenko/foodgram/" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://t.me/KhodorishchenkoValerii" className={styles.textLink}>Ходорищенко Валерий</a>
            </p>
          </div>
        </aside>
      </div>
